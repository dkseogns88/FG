...
#include "GradAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FGradAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UGradAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FGradAbilityTagRelationship> AbilityTagRelationships;
